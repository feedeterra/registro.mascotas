...
const SAMPLE_DOGS = [
  { id: "s01", name: "Rocky", breed: "Labrador", color: "Dorado", size: "Grande", sex: "Macho", neutered: "Sí", ownerName: "Martín López", ownerPhone: "+5492346301111", neighborhood: "Centro", notes: "Muy amigable.", photo: null, type: "owned", hasCollar: "Sí", collarColor: "Azul", lostSince: new Date(Date.now() - 3 * 3600000).toISOString(), lastSeenLocation: "Plaza San Martín, Centro", sightings: [{ id: "si1", text: "Lo vi corriendo por la plaza", location: "Plaza San Martín", date: new Date(Date.now() - 2 * 3600000).toISOString() }, { id: "si2", text: "Echado en la vereda de la panadería", location: "Av. Mitre 450", date: new Date(Date.now() - 1 * 3600000).toISOString() }], createdAt: new Date(Date.now() - 30 * 86400000).toISOString() },
  { id: "s02", name: "Luna", breed: "Caniche", color: "Blanco", size: "Pequeño", sex: "Hembra", neutered: "Sí", ownerName: "Carolina Ruiz", ownerPhone: "+5492346302222", neighborhood: "Barrio Norte", notes: "Moñito rosa y chip. Muy miedosa.", photo: null, type: "owned", hasCollar: "Sí", collarColor: "Rosa", lostSince: new Date(Date.now() - 18 * 3600000).toISOString(), lastSeenLocation: "Belgrano y Sarmiento", sightings: [], createdAt: new Date(Date.now() - 60 * 86400000).toISOString() },
  { id: "s03", name: "Toto", breed: "Mestizo", color: "Marrón y negro", size: "Mediano", sex: "Macho", neutered: "Sí", ownerName: "Pablo García", ownerPhone: "+5492346303333", neighborhood: "Las Quintas", notes: "Mancha blanca en el pecho.", photo: null, type: "owned", hasCollar: "No", collarColor: "", lostSince: null, lastSeenLocation: null, sightings: [], createdAt: new Date(Date.now() - 15 * 86400000).toISOString() },
  { id: "s04", name: "Mora", breed: "Pastor Alemán", color: "Negro y fuego", size: "Grande", sex: "Hembra", neutered: "Sí", ownerName: "Lucía Fernández", ownerPhone: "+5492346304444", neighborhood: "Villa del Parque", notes: "Responde a silbidos. Tiene chip.", photo: null, type: "owned", hasCollar: "Sí", collarColor: "Rojo", lostSince: null, lastSeenLocation: null, sightings: [], createdAt: new Date(Date.now() - 45 * 86400000).toISOString() },
  { id: "s05", name: "Manchas", breed: "Mestizo", color: "Blanco con manchas negras", size: "Mediano", sex: "Macho", neutered: "Sí", ownerName: "—", ownerPhone: "", neighborhood: "Estación", notes: "Se lo ve por la estación. Manso, se deja acariciar.", photo: null, type: "stray", adoptionStatus: "transit", lostSince: null, lastSeenLocation: "Estación de tren", sightings: [], createdAt: new Date(Date.now() - 10 * 86400000).toISOString() },
  { id: "s06", name: "Canela", breed: "Mestiza", color: "Marrón claro", size: "Pequeño", sex: "Hembra", neutered: "No", ownerName: "—", ownerPhone: "", neighborhood: "Ruta 8", notes: "Encontrada atropellada, se recuperó. Necesita hogar urgente.", photo: null, type: "stray", adoptionStatus: "urgent", lostSince: null, lastSeenLocation: null, sightings: [], createdAt: new Date(Date.now() - 3 * 86400000).toISOString() },
  { id: "s07", name: "Negro", breed: "Labrador mix", color: "Negro", size: "Grande", sex: "Macho", neutered: "Sí", ownerName: "—", ownerPhone: "", neighborhood: "Centro", notes: "Muy tranquilo, ideal para familia con chicos.", photo: null, type: "stray", adoptionStatus: "shelter", lostSince: null, lastSeenLocation: null, sightings: [], createdAt: new Date(Date.now() - 20 * 86400000).toISOString() },
  { id: "s08", name: "Princesa", breed: "Cocker Spaniel", color: "Dorado", size: "Mediano", sex: "Hembra", neutered: "Sí", ownerName: "—", ownerPhone: "", neighborhood: "Centro", notes: "Rescatada de situación de abandono. Cariñosa y juguetona.", photo: null, type: "stray", adoptionStatus: "shelter", lostSince: null, lastSeenLocation: null, sightings: [], createdAt: new Date(Date.now() - 14 * 86400000).toISOString() },
  { id: "s09", name: "Pirata", breed: "Mestizo", color: "Blanco y marrón", size: "Mediano", sex: "Macho", neutered: "No", ownerName: "—", ownerPhone: "", neighborhood: "Centro", notes: "Un ojo celeste, otro marrón. Súper sociable con otros perros.", photo: null, type: "stray", adoptionStatus: "shelter", lostSince: null, lastSeenLocation: null, sightings: [], createdAt: new Date(Date.now() - 30 * 86400000).toISOString() },
  { id: "s10", name: "Coco", breed: "Salchicha mix", color: "Negro y fuego", size: "Pequeño", sex: "Macho", neutered: "Sí", ownerName: "—", ownerPhone: "", neighborhood: "Ruta 8", notes: "Encontrado en la ruta. Ya vacunado y desparasitado. Urgente, necesita espacio.", photo: null, type: "stray", adoptionStatus: "urgent", lostSince: null, lastSeenLocation: null, sightings: [], createdAt: new Date(Date.now() - 5 * 86400000).toISOString() },
];
...
function generateFlyer(dog, type = "lost", previewContainer = null) {
  return new Promise((resolve) => {
    ...
    const drawContent = () => {
      ...
      if (dog.color) items.push(["COLOR", dog.color]);
      if (dog.size) items.push(["TAMAÑO", dog.size]);
      ...
      ctx.fillStyle = WHITE;
      ctx.font = "900 100px Arial, sans-serif";
      ctx.fillText(dog.ownerPhone || "SIN TELÉFONO", W / 2, contactY + 165);
    ...
    if (dog.photo) {
      ...
      img.onload = () => {
        ...
        ctx.save(); ctx.rect(0, photoTop, W, photoH); ctx.clip();
...
function DogCard({ dog, onClick, delay = 0 }) {
  ...
  return (
    <Card className={`anim d${delay}`} style={{ cursor: "pointer", overflow: "hidden", transition: "transform .2s,box-shadow .2s", border: lost ? `2px solid ${T.danger}` : stray ? `2px solid ${T.purple}` : undefined, animation: lost ? "lostPulse 2s ease-in-out infinite" : undefined }}>
      ...
      {stray && <div style={{ background: dog.adoptionStatus === "urgent" ? T.danger : T.purple, color: "#fff", padding: "6px 14px", fontSize: 12, fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <span>{dog.adoptionStatus === "urgent" ? "🚨 URGENTE" : "💜 EN ADOPCIÓN"}</span>
        <span style={{ fontSize: 11, opacity: .9 }}>{dog.adoptionStatus === "transit" ? "🏠 En tránsito" : dog.adoptionStatus === "shelter" ? "🏥 En refugio" : dog.adoptionStatus === "urgent" ? "Necesita hogar ya" : ""}</span>
      </div>}
  ...
  return (
    <div className="anim">
      <Card style={{ overflow: "hidden", border: lost ? `2px solid ${T.danger}` : stray ? `2px solid ${T.purple}` : undefined }}>
        ...
        {stray && <div style={{ background: dog.adoptionStatus === "urgent" ? T.danger : T.purple, color: "#fff", padding: "10px 16px", fontSize: 13, fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ padding: 20 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", marginBottom: 16 }}>
            ...
            {(isAdmin || isOwner) && <div style={{ display: "flex", gap: 8 }}>
              ...
              <Btn v="danger" sz="sm" onClick={() => onDelete(dog.id)} icon={I.Trash()}>{isAdmin && !isOwner ? "Eliminar" : "Eliminar"}</Btn>
            </div>}
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            {!lost && !stray && <>
              <button onClick={() => { const loc = prompt("¿Dónde lo vieron por última vez?"); if (loc !== null) onMarkLost(dog.id, loc); }} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, padding: "12px 20px", background: T.dangerLt, color: T.danger, border: `1.5px solid ${T.danger}`, borderRadius: RS, fontWeight: 700, fontSize: 14, cursor: "pointer" }}>{I.Alert()} Reportar como perdido</button>
              <a href={`https://wa.me/${dog.ownerPhone?.replace(/\D/g, "")}`} target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, padding: "12px 20px", background: "#25D366", color: "#fff", borderRadius: RS, fontWeight: 700, fontSize: 14, textDecoration: "none" }}>💬 Contactar por WhatsApp</a>
            </>}
...
export default function App() {
  ...
  const handleDelete = async (id) => { if (!confirm("¿Seguro?")) return; setDogs(dogs.filter(d => d.id !== id)); setView("list"); setSelectedDog(null); };
  ...
  return (
    ...
    <div style={{ minHeight: "100vh", background: T.bg, transition: "background .3s" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6, minWidth: 0 }}>
            {view !== "list" ? (
              ...
              <span style={{ display: "inline-flex", flexShrink: 0 }}>{I.Paw(20)}</span>
            )}
            <h1 style={{ fontFamily: "'Playfair Display',serif", fontSize: 18, fontWeight: 700, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
          ...
          {view === "list" && (
            <button onClick={() => setTab(tab === "mypets" ? "all" : "mypets")} style={{
      ...
      {showMenu && (
        <div style={{ position: "fixed", inset: 0, zIndex: 799 }} onClick={() => setShowMenu(false)}>
          <div onClick={e => e.stopPropagation()} style={{
            position: "absolute", bottom: 70, right: 12, width: 260,
            ...
            <button onClick={() => { setDark(!dark); setShowMenu(false); }} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", border: "none", borderRadius: RS, background: "transparent", color: T.txt, fontSize: 14, fontWeight: 500, cursor: "pointer", width: "100%" }}>
      ...
      <div style={{ maxWidth: 480, margin: "0 auto", padding: "12px 14px 80px" }}>
        ...
        {view === "list" && <>
          {tab !== "stats" && tab !== "shelter" && <>
            <div style={{ marginBottom: 12 }} className="anim"><div style={{ position: "relative" }}><span style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", color: T.muted }}>{I.Search()}</span><input type="text" placeholder="Buscar por nombre, raza, dueño..." value={searchInput} onChange={e => setSearchInput(e.target.value)} style={{ paddingLeft: 38, paddingRight: searchInput ? 36 : 14 }} />{searchInput && <button onClick={() => { setSearchInput(""); setSearchFilter(""); }} style={{ position: "absolute", right: 10, top: "50%", transform: "translateY(-50%)", background: T.border, border: "none", borderRadius: "50%", width: 22, height: 22, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: T.muted, fontSize: 12, fontWeight: 700 }}>✕</button>}</div></div>
            <div style={{ display: "flex", gap: 10, marginBottom: 12 }} className="anim d1">
              {tab === "stray" ? (
                ...
                <Btn onClick={() => { setSearchFilters({ size: "", color: "", breed: "", sex: "", neighborhood: "", hasCollar: "" }); navigate("search"); }} v="secondary" style={{ flex: 1, borderColor: T.navy, color: T.navy }}>🔍 Encontré un perdido</Btn></>
              ) : (
                <><Btn onClick={() => openRegister("owned")} icon={I.Plus()} style={{ flex: 1 }}>Registrar mascota</Btn>
                <Btn onClick={() => { setSearchFilters({ size: "", color: "", breed: "", sex: "", neighborhood: "", hasCollar: "" }); navigate("search"); }} v="secondary" style={{ flex: 1, borderColor: T.navy, color: T.navy }}>🔍 Encontré un perdido</Btn></>
              )}
            ...
            {/* ═══ REFUGIO CASA — Carrusel de urgentes (solo en Adopción) ═══ */}
            {tab === "stray" && (() => {
              const refugioDogs = dogs.filter(d => d.type === "stray" && (d.adoptionStatus === "urgent" || d.adoptionStatus === "shelter"));
              return refugioDogs.length > 0 ? (
                <div className="anim d1" style={{ marginBottom: 16 }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
                    <span style={{ fontSize: 13, fontWeight: 800, color: T.txt }}>🏠 Refugio CASA</span>
                    <span style={{ fontSize: 11, color: T.muted }}>{refugioDogs.length} esperando hogar</span>
                  </div>
                  <div style={{ display: "flex", gap: 10, overflowX: "auto", paddingBottom: 8, scrollSnapType: "x mandatory", WebkitOverflowScrolling: "touch" }}>
                    {refugioDogs.map(d => (
                      <div key={d.id} onClick={() => navigate("detail", d)} style={{ minWidth: 200, maxWidth: 200, scrollSnapAlign: "start", cursor: "pointer", borderRadius: R, overflow: "hidden", background: T.card, border: `1.5px solid ${d.adoptionStatus === "urgent" ? T.danger : T.purple}`, boxShadow: T.shadow, flexShrink: 0 }}>
                        <div style={{ background: d.adoptionStatus === "urgent" ? T.danger : T.purple, color: "#fff", padding: "4px 10px", fontSize: 10, fontWeight: 700, display: "flex", justifyContent: "space-between" }}>
                  ...
                  {DONATION_LINK && <a href={DONATION_LINK} target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, marginTop: 8, padding: "10px 16px", background: "linear-gradient(135deg, #f5e6c8, #e8d5a8)", color: "#8a6d3b", borderRadius: RS, fontWeight: 700, fontSize: 13, textDecoration: "none", border: "1px solid #e8d5a8" }}>☕ Invitale un plato de comida al refugio</a>}
                </div>
              ) : null;
            })()}

            {filtered.length === 0 ? <div className="anim d2" style={{ textAlign: "center", padding: "48px 20px", color: T.muted }}><div style={{ marginBottom: 12, opacity: .4 }}>{I.Dog()}</div><p style={{ fontWeight: 600, fontSize: 15, marginBottom: 4 }}>{searchFilter ? "Sin resultados" : tab === "lost" ? "No hay perdidos" : tab === "stray" ? "No hay perros sin hogar" : tab === "mypets" ? "Todavía no registraste mascotas" : "No hay registrados"}</p>{tab === "mypets" && <p style={{ fontSize: 13, marginTop: 8 }}>Registrá tu primera mascota tocando el botón +</p>}</div>
        ...
        {view === "register" && <div className="anim"><Card style={{ padding: 20 }}>
          ...
          {regStep === 1 && <div className="anim">
            ...
            {!form.photo && <p style={{ fontSize: 11, color: T.muted, textAlign: "center", marginTop: 6 }}>La foto es opcional pero ayuda a identificarla</p>}
          </div>}
          ...
          {regStep === 2 && <div className="anim">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              {form.type === "stray" && (
                <select value={form.adoptionStatus} onChange={e => setForm({ ...form, adoptionStatus: e.target.value })} style={form.adoptionStatus === "urgent" ? { borderColor: T.danger, color: T.danger } : {}}>
              ...
              <textarea placeholder={form.type === "stray" ? "Notas (dónde se lo ve, comportamiento...)" : "Notas (señas particulares, chip...)"} value={form.notes} onChange={e => setForm({ ...form, notes: e.target.value })} />
            </div>
            ...
            {!form.breed && !form.color && !form.size && <p style={{ fontSize: 11, color: T.accent, textAlign: "center", marginTop: 6 }}>Completá al menos raza, color o tamaño para que sea más fácil identificarla</p>}
          </div>}
          ...
          {regStep === 3 && <div className="anim">
            ...
            {form.type === "owned" && <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 14 }}>
              ...
              <input type="tel" placeholder="WhatsApp * (ej: 2346306562)" value={form.ownerPhone} onChange={e => { setForm({ ...form, ownerPhone: e.target.value }); setPhoneError(""); }} style={phoneError ? { borderColor: T.danger } : {}} />
              {form.ownerPhone && !phoneError && isValidWhatsApp(form.ownerPhone) && (
                <p style={{ fontSize: 12, color: T.ok, fontWeight: 600, margin: "-4px 0 0" }}>✓ Se guardará como {formatWhatsApp(form.ownerPhone)}</p>
              )}
              {form.ownerPhone && !isValidWhatsApp(form.ownerPhone) && (
                <p style={{ fontSize: 12, color: T.muted, margin: "-4px 0 0" }}>Escribí tu número sin 0 ni 15. Ej: 2346306562</p>
              )}
              {phoneError && <p style={{ color: T.danger, fontSize: 12, fontWeight: 600, margin: "-4px 0 0" }}>{phoneError}</p>}
            </div>}
        ...
        {view === "detail" && selectedDog && <DetailView dog={selectedDog} isAdmin={isAdmin} isOwner={selectedDog.userId === userId.id} onDelete={handleDelete} onEdit={handleEdit} onMarkLost={handleMarkLost} onMarkFound={handleMarkFound} onAddSighting={handleAddSighting} />}
                  ...
                  {myNotLost.map(d => (
                    <div key={d.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: 12, background: T.bg, borderRadius: RS, border: `1.5px solid ${T.border}` }}>
                      ...
                      <Btn v="danger" sz="sm" onClick={() => {
                        const loc = prompt("📍 ¿Dónde lo vieron por última vez?");
                        if (loc !== null) { handleMarkLost(d.id, loc); setTab("lost"); setView("list"); }
                      }}>Se perdió</Btn>
                    </div>
                  ))}
                </div>
                ...
                {results.map(d => (
                  <Card key={d.id} style={{ overflow: "hidden", border: d.userId === userId.id ? `1.5px solid ${T.accent}` : reportingDogId === d.id ? `2px solid ${T.danger}` : undefined }}>
                    <div style={{ display: "flex", gap: 14, padding: 14, alignItems: "center" }}>
                      ...
                      {reportingDogId !== d.id && <button onClick={(e) => { e.stopPropagation(); setReportingDogId(d.id); setReportLoc(""); }} style={{ background: T.danger, color: "#fff", border: "none", fontWeight: 700, fontSize: 12, padding: "10px 14px", borderRadius: 8, cursor: "pointer", flexShrink: 0, whiteSpace: "nowrap" }}>🚨 Reportar</button>}
                    </div>
                    {reportingDogId === d.id && (
                      <div className="anim" style={{ padding: "0 14px 14px", display: "flex", flexDirection: "column", gap: 8 }}>
                        <div style={{ background: T.dangerLt, padding: "8px 12px", borderRadius: 8, fontSize: 13, color: T.danger, fontWeight: 600 }}>📍 ¿Dónde lo vieron por última vez?</div>
                        <input placeholder="Calle, plaza, zona..." value={reportLoc} onChange={e => setReportLoc(e.target.value)} autoFocus style={{ borderColor: T.danger }} />
                        <div style={{ display: "flex", gap: 8 }}>
                          <button onClick={() => setReportingDogId(null)} style={{ flex: 1, padding: "10px", background: T.borderLt, color: T.muted, border: "none", borderRadius: 8, fontWeight: 600, fontSize: 13, cursor: "pointer" }}>Cancelar</button>
                          <button onClick={() => { handleMarkLost(d.id, reportLoc); setTab("lost"); setView("list"); setPickSearch(""); setReportingDogId(null); setReportLoc(""); setToast("🚨 Reportado como perdido"); setTimeout(() => setToast(""), 3000); }} style={{ flex: 2, padding: "10px", background: T.danger, color: "#fff", border: "none", borderRadius: 8, fontWeight: 700, fontSize: 14, cursor: "pointer" }}>🚨 Confirmar reporte</button>
                        </div>
                      </div>
                    )}
                  </Card>
        ...
        {view === "search" && <div className="anim"><Card style={{ padding: 20 }}>
          <div style={{ textAlign: "center", marginBottom: 16 }}>
            ...
            <p style={{ fontSize: 13, color: T.muted, lineHeight: 1.5 }}>Describilo y buscamos coincidencias con los registrados.</p>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            <div style={{ display: "flex", gap: 10 }}>
            ...
            <Btn onClick={handleFilterSearch} disabled={!searchFilters.size && !searchFilters.color && !searchFilters.breed && !searchFilters.sex && !searchFilters.neighborhood && !searchFilters.hasCollar} sz="lg" style={{ width: "100%", justifyContent: "center", marginTop: 4 }} icon={I.Search()}>Buscar coincidencias</Btn>
          </div>
        </Card></div>}
                ...
                {searchResults.map(d => (
                  <Card key={d.id} style={{ overflow: "hidden" }}>
                    ...
                    <div style={{ display: "flex", gap: 14, padding: 14 }}>
                      ...
                      {!d.lostSince && <button onClick={(e) => { e.stopPropagation(); const loc = prompt("📍 ¿Dónde lo viste?"); if (loc !== null) { handleMarkLost(d.id, loc); setTab("lost"); setView("list"); } }} style={{ background: T.dangerLt, border: `1px solid ${T.danger}`, borderRadius: RS, color: T.danger, fontWeight: 700, fontSize: 11, cursor: "pointer", padding: "8px 10px", flexShrink: 0, alignSelf: "center" }}>🚨 Reportar</button>}
                    </div>
                  </Card>
                ))}
              </div>
      ...
      {/* Toast notification */}
      {toast && <div style={{ position: "fixed", top: 80, left: "50%", transform: "translateX(-50%)", background: T.txt, color: T.bg, padding: "12px 24px", borderRadius: 12, fontSize: 14, fontWeight: 700, zIndex: 1100, boxShadow: T.shadowLg, animation: "fadeIn .3s ease-out" }}>{toast}</div>}

      {/* Bottom Navigation Bar */}
      {(() => {
        const navBtn = (id, emoji, label, onClick, isActive) => (
          <button key={id} onClick={onClick} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 2, background: "none", border: "none", padding: "6px 0", cursor: "pointer", color: isActive ? T.accent : T.muted, fontSize: 10, fontWeight: 600, transition: "color .2s" }}>
        ...
        return <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 800, background: T.card, borderTop: `1px solid ${T.border}`, padding: "6px 0 env(safe-area-inset-bottom, 6px)", display: "flex", alignItems: "center", justifyContent: "space-around", boxShadow: "0 -2px 10px rgba(0,0,0,.06)" }}>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center" }}>
            ...
            <span style={{ fontSize: 10, fontWeight: 600, color: T.accent, marginTop: 2 }}>Registrar</span>
          </div>
          {navBtn("stray", "💜", "Adopción", () => { setTab("stray"); setView("list"); setShowMenu(false); }, tab === "stray" && view === "list")}
