...
const dogs = [
  {
    name: 'Canela', species: 'dog', breed: 'Mestiza', color: 'Marrón claro', size: 'medium',
  ...
  {
    name: 'Mora', species: 'dog', breed: 'Pitbull mix', color: 'Atigrada', size: 'medium',
  ...
  {
    name: 'Nena', species: 'dog', breed: 'Criolla', color: 'Negra con patas blancas', size: 'medium',
    sex: 'female', neutered: false, type: 'stray', status: 'found', adoption_status: 'urgent',
    neighborhood: 'Ruta 8',
  ...
  {
    name: 'Rocky', species: 'dog', breed: 'Labrador mix', color: 'Dorado', size: 'large',
  ...
  {
    name: 'Toto', species: 'dog', breed: 'Mestizo', color: 'Negro', size: 'large',
    sex: 'male', neutered: true, type: 'stray', status: 'found', adoption_status: 'shelter',
    neighborhood: 'Refugio CASA',
  ...
  {
    name: 'Coco', species: 'dog', breed: 'Caniche mix', color: 'Blanco', size: 'small',
  ...
  {
    name: 'Firulais', species: 'dog', breed: 'Mestizo', color: 'Marrón y blanco', size: 'medium',
    sex: 'male', neutered: true, type: 'stray', status: 'found', adoption_status: 'shelter',
    neighborhood: 'Refugio CASA',
  ...
  {
    name: 'Bruno', species: 'dog', breed: 'Rottweiler mix', color: 'Negro y marrón', size: 'large',
    sex: 'male', neutered: true, type: 'stray', status: 'found', adoption_status: 'shelter',
    neighborhood: 'Refugio CASA',
  ...
  {
    name: 'Manchas', species: 'dog', breed: 'Dálmata mix', color: 'Blanco con manchas negras', size: 'medium',
    sex: 'male', neutered: false, type: 'stray', status: 'found', adoption_status: 'shelter',
    neighborhood: 'Refugio CASA',
  ...
  {
    name: 'Luna', species: 'dog', breed: 'Caniche', color: 'Blanca', size: 'small',
  ...
  {
    name: 'Laika', species: 'dog', breed: 'Pastor Alemán mix', color: 'Negro y fuego', size: 'large',
    sex: 'female', neutered: true, type: 'stray', status: 'found', adoption_status: 'transit',
  ...
  {
    name: 'Lola', species: 'dog', breed: 'Mestiza', color: 'Canela', size: 'small',
