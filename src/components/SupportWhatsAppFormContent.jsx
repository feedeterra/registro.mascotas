...
/**
 * Formulario de soporte / WhatsApp (sin FAB). Usado dentro del modal unificado de contacto.
 * @param {{ onAfterWhatsAppOpen?: () => void }} props
 */
export default function SupportWhatsAppFormContent({ onAfterWhatsAppOpen }) {
  const T = useT()
  ...
  }, [isLogged, profile?.display_name, profile?.phone, profile?.email, session?.user?.email])
  ...
  return (
    <>
      ...
      <div>
        <p style={{ fontSize: 12, color: T.muted, marginTop: 0, marginBottom: 12, lineHeight: 1.45 }}>
