...
INSERT INTO public.pets (name, species, color, size, sex, neutered, photos, primary_photo_idx, type, status, adoption_status, neighborhood, notes, registered_via, created_at)
VALUES
  -- URGENTES
  ('Canela', 'dog', 'Marrón claro', 'Mediano', 'Hembra', true,
  ...
  ('Mora', 'dog', 'Atigrada', 'Mediano', 'Hembra', false,
  ...
  ('Nena', 'dog', 'Negra con patas blancas', 'Mediano', 'Hembra', false,
  ...
  -- EN REFUGIO
  ('Rocky', 'dog', 'Dorado', 'Grande', 'Macho', true,
  ...
  ('Toto', 'dog', 'Negro', 'Grande', 'Macho', true,
  ...
  ('Coco', 'dog', 'Blanco', 'Chico', 'Macho', false,
  ...
  ('Firulais', 'dog', 'Marrón y blanco', 'Mediano', 'Macho', true,
  ...
  ('Bruno', 'dog', 'Negro y marrón', 'Grande', 'Macho', true,
  ...
  ('Manchas', 'dog', 'Blanco con manchas negras', 'Mediano', 'Macho', false,
  ...
  -- EN TRÁNSITO
  ('Luna', 'dog', 'Blanca', 'Chico', 'Hembra', true,
  ...
  ('Laika', 'dog', 'Negro y fuego', 'Grande', 'Hembra', true,
  ...
  ('Lola', 'dog', 'Canela', 'Chico', 'Hembra', false,
